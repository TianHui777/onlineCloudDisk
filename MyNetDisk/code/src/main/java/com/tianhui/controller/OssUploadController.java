...
import static com.tianhui.utils.InitVodCilent.initVodClient;
...
public class OssUploadController {
    ...
    public R upload(MultipartFile file, @RequestParam String catalogue, @PathVariable String userId) {
    ...
    public R removeAlyVideo(@RequestParam("idList") String[] idList, @PathVariable String userId) {
